...
module.exports = {
  endbuy: {
    ...
    error: '**There is no purchase to cancel!**'
  },
  public: {
  ...
  redeemcode: {
    ...
    entercode: '**Please select the code!**',
    codeexp: "**This code is invalid or expired.**",
    already: '**I have already used this code!**'
  },
  help: {
    helps: {
  ...
  setprefix: {
    ...
    done: `${style}**${done} | Prefix changed successfully !**`,
    reset: `${style}**${done} | The prefix has been successfully reset !**`
  },
  setlanguage: {
    helps: {
