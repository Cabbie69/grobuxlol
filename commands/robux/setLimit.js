...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    if (
      isNaN(args[0].toString()) ||
      parseInt(args[0].toString()) != args[0].toString() ||
      parseInt(args[0].toString()) < 1
    )
      return message.lineReplyNoMention(replys.invalid);
    if (args[0].toString() == data.system.limit)
      return message.lineReplyNoMention(replys.already);
